...
if __name__ == "__main__":
    ...
    sentence = input("\n\nPlease enter your Medical text for Named Entity Recognition:\n\n")
    sentence_tokens = sentence.split()

    tokens, labels = [], []
    for sentence_batch in chunks(sentence_tokens, config.TEST_CHUNK_SIZE):
    ...
    print("\n",colored("problem", "red"),"\n",colored("treatment", "blue"),"\n",colored("test", "green"),"\n",colored("person", "yellow"),"\n",colored("pronoun", "magenta"),"\n")
